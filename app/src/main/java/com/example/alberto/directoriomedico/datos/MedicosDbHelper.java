...
public class MedicosDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE "
                        ...
                        + PacientesContract.PacientesEntry._ID
                        + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                        ...
                        + " TEXT,"
                        + " UNIQUE (" + PacientesContract.PacientesEntry.ID +"),"
                        + " FOREIGN KEY (" + PacientesContract.PacientesEntry.ID_MEDICO + ")"
                        + " REFERENCES " + MedicosContract.MedicoEntry.TABLE_NAME + " ("
                        + MedicosContract.MedicoEntry.ID + "))"
        );
